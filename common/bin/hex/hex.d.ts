...
export declare class Axial {
     ...
     * @returns {boolean}
     */
    compareTo(other: Axial | undefined): boolean;
}
/**
...
export declare class Grid {
     ...
     */
    getDistance(a: Axial, b: Axial): number;
    /**
     ...
     */
    getRange(start: Hexagon, movement: number): Hexagon[];
    /**
     ...
     */
    findPath(start: Hexagon, end: Hexagon): Hexagon[];
}
/**
